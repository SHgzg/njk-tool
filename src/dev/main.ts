...
app.get('/email/:file', async (req, res) => {
    ...
    const transporter = nodemailer.createTransport({
        ...
        secure: true,
        auth: {
            user: '1754737900@qq.com', 
            pass: 'zhzddzfhypwzfbji' 
        }
    });
    const sendEmail = async () => {
        const mailOptions = {
            from: '1754737900@qq.com',
            // to: '1754737900@qq.com',
            to: '1754737900@qq.com, gongzhaoguo@xy-ai.com',
            subject: '邮件主题',
            html
        }
        try {
